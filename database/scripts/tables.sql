CREATE TABLE Cliente(id INTEGER PRIMARY KEY AUTOINCREMENT, nome_fantasia varchar(255), razao_social varchar(255), telefones varchar(255), cnpj_cpf varchar(14), tipo varchar(255), loja_risco varchar(255), codigo varchar(255), contato varchar(255));
